...
% Last Modified by GUIDE v2.5 20-Oct-2013 11:06:53
...
SetMontageParametersDefaults % create or update MontageParameters field 
...
%set(handles.IsSingle_AF_ForWholeMontage_radiobutton, 'Value', GuiGlobalsStruct.MontageParameters.IsSingle_AF_ForWholeMontage);
Value = get(handles.NoAuto_radiobutton, 'Value');
GuiGlobalsStruct.MontageParameters.NoAuto = Value;
...
% --- Otherwise, executes on mouse press in 5 pixel border or over NoAuto_radiobutton.
function NoAuto_radiobutton_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to NoAuto_radiobutton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
