...
%if exist('ImageParams', 'var')
    FOV_microns = GuiGlobalsStruct.MontageParameters.AFTestImageFOV_microns;
    ImageWidthInPixels = GuiGlobalsStruct.MontageParameters.AFTestImageWidth_pixels;
    ImageHeightInPixels = GuiGlobalsStruct.MontageParameters.AFTestImageWidth_pixels;
    DwellTimeInMicroseconds = GuiGlobalsStruct.MontageParameters.AFTestImageDwellTime_microseconds;
